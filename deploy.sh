...
scp -o StrictHostKeyChecking=no -i $SSH_KEY index.html styles.css app.js app_server.py manifest.json favicon.svg sw.js setup_https.sh $REMOTE_USER@$SERVER_IP:$REMOTE_DIR/
